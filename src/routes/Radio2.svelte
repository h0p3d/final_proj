<script>
    ...
    export let comparison_options;
    export let legend;
    export let userComparisonSelected = comparison_options[0].value;
  ...
  <div role="radiogroup"
    ...
    {#each comparison_options as { value, label }}
      <input
        class="sr-only"
        type="radio"
        id={slugify(label)}
        bind:group={userComparisonSelected}
        value={value} />
